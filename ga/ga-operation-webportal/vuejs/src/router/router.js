...
export const otherRouter = {
    ...
    children: [
        ...
        { path: '/aircraftmonitoring/repairmodifiedinfo', title: { i18n: '重要维修与改装' }, name: 'repairmodifiedinfo', component: () => import('@/components/pages/aircraftmonitoring/repairmodifiedinfo.vue') },
