...
// 获取用户数据 多条件
export const getUserListData = (cid,params) => {
    return getRequest(`/user/getByCondition/${cid}` , params)
}
// 添加用户
export const addUser = (type,params) => {
    return postRequest(`/user/admin/add/${type}`, params)
}
// 编辑用户
