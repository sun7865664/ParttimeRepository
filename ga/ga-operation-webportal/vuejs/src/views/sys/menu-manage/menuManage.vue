    ...
    <div class="search">
        <Card>
          <Row class="operation" style="margin-bottom: 10px">
            <Button v-has="'add'" @click="addMenu" type="primary" icon="md-add">添加子节点</Button>
            <Button v-has="'add'" @click="addRootMenu" icon="md-add">添加一级菜单</Button>
