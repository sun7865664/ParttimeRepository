...
<template >
    <div style="width: 965px; margin-left: 12px;">
        ...
        <span style="font-size: 16px;color: rgba(255, 255, 255, 1);">事务处理-已办事项</span>
        </div>
        ...
        <div class="physicalp" >
            <div  style="margin-top:10px;">
                <div class="bottom5" style="margin-top:5px;padding:10px;">
                    <Table stripe border :columns="columns7" :data="pendlist"></Table>
                </div>
               <Page :total="pagecount" @on-change="pageclick" @on-page-size-change="pagesizeclick" :page-size="pagesize" style="float: right" show-sizer ></Page>
            </div>
        </div>
        </div>
    </div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                columns7: [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        render (h, params) {
                            return typelist[params.row.status];
                        }
                    },{
                        title: '操作',
                        key: 'action',
        ...
        methods: {
            init: function (obj) {
                let self = this;
                self.$http.httpGet('/app/api/processrun/completedlist',{
            ...
            //查看详情
            task(index) {
                this.$http.httpHref('/app/api/processrun/getflowinfo',
                    {
                    prePage:'myCompletedList',
                    link:1,
                    runId:index,
                    }
                );
