<template>
    <div>
        ...
        <div style="margin-bottom: 3px">
            ...
            <!--<div class="tit active div-list-aircraftdata" @click="open.base_info_open = !open.base_info_open">-->
                    <!--<span class="fr">-->
                        <!--<Icon :type="open.base_info_open? 'minus':'plus'"></Icon>-->
                    <!--</span>-->
                <!--<div>    <img src="../../assets/基本信息.png" class="logoimgpoilt">基础资料</div>-->
            <!--</div>-->
            <div class="cut container-center employeecut"    v-show="open.base_info_open">
                <table style="border: 1px solid;width:965px;border-spacing:0px; border: solid 1px rgba(1, 107, 217, 1);">
                    <tbody>
                    <tr>
                        <td class="tr-one tr-third">姓名</td>
                        <td class="tr-two-author tr-four">{{employee.userName}}</td>
                        <td class="tr-one tr-third">性别</td>
                        ...
                        <td rowspan="4" colspan="2" style="width:180px;padding-top: 20px;padding-left: 20px">
                            <div  v-if="employee.photo">
                                <img :src="employee.photo" style="width:140px;height: 135px;padding-left:30px;">
                            </div>
                            <div  v-else>
                    ...
                    <tr>
                        <td class="tr-one tr-third">技术级别</td>
                        <td class="tr-two-author tr-six">{{employee.techgrade}}</td>
                        <td class="tr-one tr-five">技术职务</td>
                        <td class="tr-two-author tr-six">{{employee.techpos}}</td>

                    </tr>
                    <tr>
                        <td class="tr-one tr-five">员工状态</td>
                        <td class="tr-two-author tr-four">{{employee.status}}</td>
                        <td class="tr-one tr-five">护照号码</td>
                        <td class="tr-two-author tr-four">{{employee.passPort}}</td>
                    </tr>
                    <tr>
                        <td class="tr-one tr-third">身份证号码</td>
                        <td colspan="3" class="tr-six tr-senven">{{employee.cardId}}</td>
                    ...
                    <tr>
                        <td class="tr-one tr-third">家庭联系人姓名</td>
                        <td class="tr-two-author tr-four">{{employee.homeName}}</td>
                        <td class="tr-one tr-third">家庭所在国家</td>
                    ...
                    <tr>
                        <td class="tr-one tr-five">家庭电话</td>
                        <td class="tr-two-author tr-six">{{employee.homeTel}}</td>
                        <td class="tr-one tr-five">家庭手机</td>
                        <td class="tr-two-author tr-six">{{employee.homeMobile}}</td>

                    </tr>
                    <tr>
                        <td class="tr-one tr-third">家庭住址</td>
                        <td colspan="3" class="tr-four tr-senven">{{employee.homeAddress}}</td>
                    ...
                    <tr>
                        <td class="tr-one tr-third">单位联系人</td>
                        <td class="tr-two-author tr-six">{{employee.businessName}}</td>
                        <td class="tr-one tr-third">工作电话</td>
                        <td class="tr-two-author tr-six">{{employee.businessTel}}</td>
                            <td rowspan="3" colspan="2" style="width:180px;height:150px;padding:0 10px 0 22px">
                                <div  v-if="employee.scanSignature" style="width: 180px;height: 135px;margin-left: -10px">
                                    <img :src="employee.scanSignature"  style="width: 180px;height:135px;">
                                </div>
                                <div v-else>
                                    <img :src="noimg" style="width: 180px;height:135px;padding-left:5px;"/>
                                </div>
                    ...
                    <tr>
                        <td class="tr-one tr-five">单位邮编</td>
                        <td class="tr-two-author tr-four">{{employee.homePostcode}}</td>
                        <td class="tr-one tr-five">单位所在国家</td>
                        <td class="tr-two-author tr-four">{{employee.businessCountry}}</td>
                    </tr>
                    <tr>
                        <td class="tr-one tr-third" style="border-bottom: 0;">单位地址</td>
                        <td colspan="3" class="tr-six tr-senven-1" style="">{{employee.businessAddress}}</td>
        ...
        methods: {
            ...
            getflightmplementrecordsData(val){
                ...
                if (self.employeeId > 0) {
                    self.$http.httpGet('/eim/api/flightimplementrecord/findFlightImplementRecordsByEmployeeId', {employeeId:val}).then((res) => {
                        let result = res.data;
            ...
            gpflightrecordinfo(index){
                this.$emit('childinfo-typeid',this.flightimplementRecords[index].id,flightrecord);
            ...
            getData (val) {
                ...
                self.scanCardarra=[];
                if (self.employeeId > 0) {
                    let url = '/eim/api/employee/search/getdetailbyid';
                    self.$http.httpGet(url, {
                        ...
                        if (result.resultCode == 200) {
                            ...
                            self.employee = temp.employee;
                            self.prList = temp.prList;
                            self.peList = temp.peList;
                            ...
                            //飞行执照
                            self.PersonQulificationInfolist = temp.PersonQulificationInfolist;
                            if(self.employee.scanCard!=''&&self.employee.scanCard!=null) {
