<template>
    <div class="container">
        <div class="rigtht-1" v-show="politdetail"  style="float: left;margin-left: 47px">
            <p-detail v-bind:employeeId="employeeId" v-on:childinfotypeid="typeidfunction"></p-detail>
        </div>
        <div class="rigtht-1" v-show="politdetail1"  style="float: left;margin-left: 47px">
            <div  class="gacompany-div" style=" text-align: center; padding-bottom: 10px; padding-top: -1px; margin-left: 640px;">
                <button class="div-button" style="width: 100px;margin-bottom: 5px"  @click="backcompanysup()" >返  回</button>
            </div>
            <div>
