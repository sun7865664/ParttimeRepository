        ...
        <Form :label-width="205" :model="qualification" ref="formVali" style="margin-top: 20px" >
            <div>
                ...
                <Row>
                    <Col :md="12">-->
                <div>
                        <FormItem label="执照名称" style="display: inline-block;width: 550px">
                ...
                <div>
                        <FormItem label="执照颁发时间" style="display: inline-block;width: 550px" prop="issuedate" :rules="{required: true, type: 'date',message: '请选择日期', trigger: 'change'}">
                            <DatePicker v-model="qulification.issuedate" type="date" placeholder="选择颁发时间" style="width: 345px"></DatePicker>
                        </FormItem>
                   <!-- </Col>
                    <Col :md="11" v-if=" radio=='no'">-->
                        <FormItem label="执照到期时间" style="display: inline-block;width: 550px" v-if=" radio=='no'">
                            <DatePicker v-model="qulification.expiredate" type="date" placeholder="选择到期时间" style="width: 345px"></DatePicker>
                        </FormItem>
                </div>
                  <!--  </Col>
                </Row>-->
            ...
            <div  v-if="license!==null">
                <div  >
                    ...
                    <!--<Row>
                        <Col :md="12">-->
                            <FormItem label="切换执照类型" style="display: inline-block;width: 550px">
