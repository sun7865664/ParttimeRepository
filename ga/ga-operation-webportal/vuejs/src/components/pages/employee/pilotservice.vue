<template>
    <div class="container" style="width: 1280px; height: auto; margin-top: 60px;background:white">
        <!--<div class="left-1" style="float: left">
            <p-list v-on:child-info="childinfoid" ref="politlist"></p-list>
        </div>-->
        <div class="" v-show="politdetail1s"  style="float: right;">
            <div  class="" style="margin-top: 20px; margin-right: 30px ">
                <button class="div-button" style="width:88px; height:30px; border-radius:4px; border:1px solid #33A6FC; background-color: #FFFFFF; color:#33A6FC; cursor:pointer"
                        @click="backcompanysups()" >返  回</button>
            </div>
        </div>
        <div class="rigtht-1" v-show="politdetail"  style="float: left;">
            <p-detail v-bind:employeeId="employeeId" v-on:childinfotypeid="typeidfunction" ref="employeedetail"></p-detail>
        </div>
...
<script>
    ...
    import pList from '../../views/pilotservicelist.vue';
    import pDetail from '../../views/employeedetail.vue';
