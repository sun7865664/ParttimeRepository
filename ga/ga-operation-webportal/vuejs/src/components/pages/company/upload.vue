...
<script>
    export default {
        props:['uploadList','filepath','dataFileType','versionNum'],
        data () {
            return {
        ...
        methods: {
            ...
            getToken (file) {
                ...
                return new Promise((resolve, reject) => {
                    this.$http.httpGet('/eim/api/doc/findbycompanyidanddatafilenameandversionnumber/'+companyId+','+datafileName+','+versionNumber).then(res=>{
            ...
            handleBeforeUpload (file) {
                ...
                this.pathparam.name= this.dataFileType
